...
0. **frontend-design 스킬 우선 로드**: 작업 시작 시 frontend-design 스킬을 로드해 타이포그래피·
   위계·여백·컬러 사용 등 미적 방향의 가이드로 삼는다. 스킬 미설치 시 그 사실을 보고하고
   아래 규칙만으로 진행한다. 스킬 제안이 브랜드·현행 유지 제약과 충돌하면 본 문서와 CLAUDE.md가 우선한다
